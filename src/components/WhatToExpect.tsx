      ...
      <div className="container px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-2xl">
            <img alt="Luxurious facial treatment at Rolora" className="w-full h-[500px] md:h-[600px] object-cover" src="/lovable-uploads/2a92e8b2-88d4-4b04-982c-185016f27f58.jpg" />
