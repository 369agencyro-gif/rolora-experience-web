        ...
        <div className="container px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-primary">
              ...
              {[
                {
                  name: "Sarah M.",
                  rating: 5,
                  text: "I feel so much lighter after every session! The bloating is gone and my legs look more sculpted. This is my new self-care essential."
                },
                {
                  name: "Jessica L.",
                  rating: 5,
                  text: "The lymphatic drainage is incredible. I noticed visible results after just one session. My body feels energized and refreshed!"
                },
                {
                  name: "Amanda K.",
                  rating: 5,
                  text: "Best decision I made for my wellness routine. The Rolora Flow helps with my post-workout recovery and keeps me feeling tight and toned."
                },
                {
                  name: "Michelle R.",
                  rating: 5,
                  text: "I was skeptical at first, but WOW. The combination of rolling and infrared therapy is pure magic. My skin looks smoother too!"
                },
                {
                  name: "Lisa P.",
                  rating: 5,
                  text: "This is NOT just a massage - it's so much more effective. I see real contouring results and my energy levels have improved dramatically."
                },
                {
                  name: "Rachel T.",
                  rating: 5,
                  text: "The structured sequence targets every area perfectly. I love how it reduces my water retention and leaves me feeling sculpted and confident."
                }
              ].map((testimonial, index) => (
                <div
                  key={testimonial.name}
                  className="group relative p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all duration-500 hover:scale-105 animate-fade-in"
