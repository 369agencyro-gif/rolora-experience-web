          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                ...
                "High-end devices + techniques used intentionally",
                "Glow + flow philosophy – lymphatic focus for face and body",
                "Founder-led protocols from years with Newport Beach's high-end clientele"
              ].map((item, i) => (
      ...
      <section className="py-12 bg-background">
        <div className="container px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
            ...
            <div className="relative aspect-[4/3] overflow-hidden">
              <img src={studioInterior} alt="Rolora Studio Interior" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                { name: "S.T.", text: "My skin has never looked this good. The custom serum blend made all the difference." },
                { name: "J.R.", text: "Worth every penny. The results are immediate and keep getting better." }
              ].map((review, i) => (
                <div key={i} className="p-6 rounded-xl bg-background/50 border border-border/50 hover:shadow-lg transition-all duration-300">
