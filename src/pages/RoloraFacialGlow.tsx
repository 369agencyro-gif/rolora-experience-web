                ...
                <div className="max-w-4xl mx-auto">
                  <ul className="grid md:grid-cols-2 gap-6">
                    <li className="flex items-start gap-4 bg-primary-foreground/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-primary-foreground/15 transition-colors">
                      ...
                      <span className="text-lg leading-relaxed">Anyone seeking the signature Rolora glow and luminous skin</span>
                    </li>
                    <li className="flex items-start gap-4 bg-primary-foreground/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-primary-foreground/15 transition-colors">
                      <span className="text-3xl flex-shrink-0">✨</span>
                      <span className="text-lg leading-relaxed">Dull, tired skin in need of revitalization</span>
                    </li>
                    <li className="flex items-start gap-4 bg-primary-foreground/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-primary-foreground/15 transition-colors">
                      <span className="text-3xl flex-shrink-0">✨</span>
                      <span className="text-lg leading-relaxed">Uneven texture or fine lines requiring smoothing</span>
                    </li>
                    <li className="flex items-start gap-4 bg-primary-foreground/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-primary-foreground/15 transition-colors">
                      <span className="text-3xl flex-shrink-0">✨</span>
                      <span className="text-lg leading-relaxed">Pre-event preparation for camera-ready skin</span>
                    </li>
                    <li className="flex items-start gap-4 bg-primary-foreground/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-primary-foreground/15 transition-colors md:col-span-2 max-w-2xl mx-auto">
                      <span className="text-3xl flex-shrink-0">✨</span>
                      <span className="text-lg leading-relaxed">Regular maintenance for sustained radiance</span>
                    </li>
                  </ul>
                </div>
              </div>
